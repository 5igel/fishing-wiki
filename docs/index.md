...
- [gear-terminal](gear-terminal.md) — гачки, вертлюги, фурнітура, годівниці (клітки 10–20 г / 30–60 г / Preston ICS Dura Flat), повідці Kamasan Method, шпаргалка обертів N'ZON, інструменти

## Техніка
- [technique-rigging](technique-rigging.md) — оснастка, довжини, монтаж, модульна матчева (знімна груз-секція), транспортування, донні комплекти (малий пробіг/летючий свинець/пробіг), flat method (дебют 09-15: повідці 15 см у план, пошук перепаду часом падіння)
- [technique-ballasting](technique-ballasting.md) — огрузка: китайський/корейський стиль
- [technique-feeding](technique-feeding.md) — годівля/закорм на платних ставках (мало й часто; дрібняк) + фідер: MatchPro + Traper Karmel + ліквід Sonubaits; трофейна схема (щільний закорм 60 г/15 хв + бутерброд кукурудза+пінка на №10); флет-суміш 70/30 (осінь) vs чистий мікропелет (тест)
- [technique-knots](technique-knots.md) — в'язання, рвані повідці, виважування, конектор-подовжувач

## Риба
- [fish-log](fish-log.md) — види, улови, вага по довжині
...
- [shopping](shopping.md) — куплено / в процесі / спробувати; осінні атрактанти (Krill / Halibut / Spicy Sausage)
